...
public class ArcanusConfigScreen extends ConfigScreen {
	...
	protected void createFooter() {
		...
		addRenderableWidget(Button.builder(Component.translatable("config.arcanuscontinuum.supporter_settings").withStyle(ChatFormatting.AQUA), buttonWidget -> SupporterScreen.open(this)).bounds(width / 2 - 55, height - 27, 110, 20).build());
	}
}
